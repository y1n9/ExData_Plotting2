...
baltimore_emissions_yr <- aggregate(Emissions~year, baltimore, sum)

# plot2
png("plot2.png", width = 480, height = 480)
with(baltimore_emissions_yr, barplot(Emissions, year, col="wheat", main="Total PM2.5 Emissions in Baltimore City", 
